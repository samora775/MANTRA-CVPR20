...
class Transformer(nn.Module):
    ...
    def __init__(self, settings, d_model=512, nhead=8, num_encoder_layers=6,
        ...
        encoder_layer_past = TransformerEncoderLayer(d_model, nhead, dim_feedforward,
                                                dropout, activation, normalize_before)
        encoder_layer_future = TransformerEncoderLayer(d_model, nhead, dim_feedforward,
                                                     dropout, activation, normalize_before)
        encoder_norm = nn.LayerNorm(d_model) if normalize_before else None

        self.encoder_past = TransformerEncoder(encoder_layer_past, num_encoder_layers, encoder_norm)
        self.encoder_fut = TransformerEncoder(encoder_layer_future, num_encoder_layers, encoder_norm)
